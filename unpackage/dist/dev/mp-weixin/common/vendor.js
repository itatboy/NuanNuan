  ...
  list: [
    {
      ...
      selectedIconPath: "static/tabbar/tab1-a.png"
    },
    {
      pagePath: "pages/census/census",
      iconPath: "static/tabbar/tab2.png",
      selectedIconPath: "static/tabbar/tab2-a.png"
    },
    {
      pagePath: "pages/my/my",
      iconPath: "static/tabbar/tab3.png",
      selectedIconPath: "static/tabbar/tab3-a.png"
    }
  ]
};
const t = {
...
let S;
S = _;
const k = m('{\n    "address": [\n        "127.0.0.1",\n        "192.168.126.1",\n        "192.168.248.1",\n        "192.168.88.226"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "C:/Users/tatbo/Desktop/HBuilderX.3.6.17.20230112/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), I = m('[{"provider":"aliyun","spaceName":"server","spaceId":"mp-12450679-7069-4b89-aba0-4112c8969ec8","clientSecret":"wBQvLhnYoZUwPG4yLnq1Ug==","endpoint":"https://api.next.bspapp.com"}]') || [];
let T = "";
try {
  T = "__UNI__164A8E3";
} catch (e2) {
